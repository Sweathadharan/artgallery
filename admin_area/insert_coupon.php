...
$get_coupons = "select * from voucher where (product_id='$product_id' and product_title='$pro_title') or coupon_code='$coupon_code'";
...
$insert_coupon = "insert into voucher (product_id,coupon_title,product_title,coupon_price,coupon_code,coupon_limit,coupon_used) values ('$pro_id','$coupon_title','$pro_title',$coupon_price,'$coupon_code',$coupon_limit,$coupon_used)";
