...
?>
<select name="cat_title" class="form-control" required>
<option value="<?php echo $cat_title;?>" selected><?php echo $cat_title;?></option>
<option value=0>---Select Category---</option>
<?php
$query1="select distinct cat_title from categories where delete_tab=0";
...
<img src="procat_images/<?php echo $p_cat_image; ?>" width="70" height="70" >
...
$update_p_cat = "update product_categories set cat_title='$cat_title',p_cat_title='$p_cat_title',p_cat_top='$p_cat_top',p_cat_image='$p_cat_image' where p_cat_id='$p_cat_id'";
