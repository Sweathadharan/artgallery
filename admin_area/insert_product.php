...
Product Url Example : Art At Best price
...
echo "<option value='$manufacturer_title'>$manufacturer_title</option>";
...
$pcatq="select p_cat_id from product_categories where p_cat_title='$product_cat'";
$runpcatq=mysqli_query($con,$pcatq);
list($p_cat_id)=mysqli_fetch_array($runpcatq);


$catq="select cat_id from categories where cat_title='$cat'";
$runcatq=mysqli_query($con,$catq);
list($cat_id)=mysqli_fetch_array($runcatq);

$manufacturerq="select manufacturer_id from manufacturers where manufacturer_title='$manufacturer_id'";
$runmcatq=mysqli_query($con,$manufacturerq);
list($manufacturer_id)=mysqli_fetch_array($runmcatq);


$insert_product = "insert into products (p_cat_id,cat_id,manufacturer_id,date,product_title,product_url,product_img1,product_img2,product_img3,product_price,product_psp_price,product_desc,product_features,product_video,product_keywords,product_label,status) values ('$p_cat_id','$cat_id','$manufacturer_id',NOW(),'$product_title','$product_url','$product_img1','$product_img2','$product_img3','$product_price','$psp_price','$product_desc','$product_features','$product_video','$product_keywords','$product_label','$status')";
