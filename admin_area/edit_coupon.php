...
$edit_coupon = "select * from voucher where coupon_id='$edit_id'";
...
$get_products = "select * from products where product_id='$p_id'  and product_title='$p_title'";
...
<option value="<?php echo $product_title,',',$product_id; ?>" selected> <?php echo $product_title; ?> </option>
...
echo "<option value='$p_title,$p_id'> $p_title </option>";
...
$update_coupon = "update coupons set product_id='$pro_id',product_title='$pro_title',coupon_title='$coupon_title',coupon_price='$coupon_price',coupon_code='$coupon_code',coupon_limit='$coupon_limit',coupon_used='$c_used' where coupon_id='$c_id'";
