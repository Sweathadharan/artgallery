...
$c_description = $row_edit['cat_meta_description'];

$c_keywords = $row_edit['cat_meta_keywords'];
...
<input type="text" name="cat_description" class="form-control" value="<?php echo $c_description;?>" required>
...
<input type="text" name="cat_keywords" class="form-control" value="<?php echo  $c_keywords;?>" required>
...
<label class="col-md-3 control-label">Select Category Image <br>
<font color='red'>273 * 273</font></label>
...
$cat_keywords = $_POST['cat_keywords'];
...
$update_cat = "update categories set cat_title='$cat_title',cat_meta_description='$cat_description',cat_meta_keywords='$cat_keywords',cat_top='$cat_top',cat_image='$cat_image' where cat_id='$c_id'";
