...
$get_cats = "select * from categories where delete_tab=0";
...
$cat_description=$row_cats['cat_meta_description'];

$cat_keywords=$row_cats['cat_meta_keywords'];
