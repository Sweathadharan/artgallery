...
<input type="text" name="cat_keywords" class="form-control" required>
...
<input type="radio" name="cat_top" value="yes" checked>
...
{
echo "<script> alert('Same Category Already Available')</script>";
...
$insert_cat = "insert into categories (cat_title,cat_meta_description,cat_meta_keywords,cat_top,cat_image) values ('$cat_title','$cat_description','$cat_keywords','$cat_top','$cat_image')";
echo $insert_cat;
