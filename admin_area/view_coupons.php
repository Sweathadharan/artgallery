...
<i class="fa fa-dashboard"></i> Dashboard / View Voucher
...
<i class="fa fa-money fa-fw"></i> View voucher
...
$get_coupons = "select * from voucher";
...
$product_title = $row_coupons['product_title'];
